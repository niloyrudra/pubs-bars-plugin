...
<div class="pbp-wrapper">
    ...
    <div class="pbp-container">
        ...
        <div class="pbp-live-search--container">
            ...
            <h1>Search For Pubs or Bars:</h1>

            <form action="<?php //echo esc_url(PLUGIN_PATH . 'custom-page/'); ?>" method="get">

                <input type="text" name="pbp_search" id="pbp_search" placeholder="Write You Query">
        ...
        <div class="pbp-search--result__container">
        
            <div class="result-content"></div><!-- .result-content -->

        </div><!-- .pbp-search--result__container -->
